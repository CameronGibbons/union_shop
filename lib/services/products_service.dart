...
class ProductsService {
  ...
  final List<Product> _products = [
    ...
    Product(
      ...
      isSale: true,
      collectionId: 'essential-range',
      description: 'Limited edition zip-up hoodies on sale',
    ),
    Product(
      id: 'essential-tshirt',
      name: 'Essential T-Shirt',
      ...
      isSale: true,
      collectionId: 'essential-range',
      description: 'Comfortable essential t-shirt on sale',
    ),
    Product(
      id: 'signature-hoodie-featured',
      name: 'Signature Hoodie',
      price: 32.99,
      imageUrl: 'assets/images/signature_hoodie.png',
      category: 'Clothing',
      ...
      description: 'Premium signature hoodie with university branding',
    ),
    Product(
      id: 'signature-tshirt-featured',
      ...
      stock: 50,
      collectionId: 'signature-range',
      description: 'Classic signature t-shirt with university branding',
    ),
    Product(
      ...
      colors: ['Multi'],
      stock: 100,
      collectionId: 'portsmouth-city',
      description: 'Beautiful Portsmouth city postcard',
    ),
    Product(
      ...
      stock: 75,
      collectionId: 'portsmouth-city',
      description: 'Portsmouth city fridge magnet',
    ),
    Product(
      ...
      stock: 80,
      collectionId: 'portsmouth-city',
      description: 'Portsmouth themed bookmark',
    ),
    Product(
      ...
      stock: 45,
      collectionId: 'portsmouth-city',
      description: 'Portsmouth city themed notebook',
    ),
  ];
