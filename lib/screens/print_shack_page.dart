            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    final price =
                        _selectedLines == 'One Line of Text' ? 3.0 : 5.0;
                    final customText = _selectedLines == 'One Line of Text'
                        ? _line1Controller.text
                        : '${_line1Controller.text} / ${_line2Controller.text}';
                    final cartItem = CartItem(
                      productId: 'personalisation',
                      productName: 'Personalisation - $_selectedLines',
                      price: price,
                      quantity: _quantity,
                      imageUrl: 'assets/images/print_shack_hoodie.png',
                      color: customText.isNotEmpty ? customText : null,
                    );
